namespace AurumRest
{
	partial class RemotasForm
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(RemotasForm));
			...
			this.label3.Text = "Dirección de Impresora";
			// 
			// textoBoxp3
			// 
			...
			this.textoBoxp3.Location = new System.Drawing.Point(195, 107);
			this.textoBoxp3.MaxLength = 29;
			this.textoBoxp3.Name = "textoBoxp3";
			this.textoBoxp3.Size = new System.Drawing.Size(369, 29);
			this.textoBoxp3.TabIndex = 8;
			this.textoBoxp3.Text = "Nombre Lógico de Impresora";
			// 
			// labelindex
			// 
			...
			this.textoBoxp2.Location = new System.Drawing.Point(195, 60);
			...
			this.textoBoxp2.Text = "Lugar donde se encuentra";
			// 
			// RemotasForm
			// 
