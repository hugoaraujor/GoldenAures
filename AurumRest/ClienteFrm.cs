...
namespace AurumRest
{
	public partial class ClienteFrm : Form
	{
		...
		private void BorrarBtn_Click(object sender, EventArgs e)
		{
			...
			if (currentcliente != null )
			{
				if (currentcliente.Idcliente != -1)
				{
					...
					Varios.Mensaje(errorBar1, "El Registro ha sido eliminado con exito", errorType.Alert);
				}
			}
			else
			{		Varios.Mensaje(errorBar1, "Debe seleccionar un usuario", errorType.Info);	}
		...
		private void GuardarBtn_Click(object sender, EventArgs e)
		{
			...
			{
				Varios.Mensaje(errorBar1, validarRegistro(recordActual), errorType.Error);
			}
		}
